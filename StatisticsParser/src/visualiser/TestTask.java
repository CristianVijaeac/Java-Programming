...
public class TestTask {
	...
	public TestTask() {
		...
		userEvent1.setPageArea(new Canvas(Lists.newArrayList(
				new EditorElement("\"input\""),
				new EditorElement("\"div\""),
				new EditorElement("\"div\""))));
		userEvent2.setPageArea(new Canvas(Lists.newArrayList(
	...
	public void determineAreaForCanvas_card() {
		...
		assertEquals(
				new HashSet<Object>(determinedPageArea.getPathInEditor()),
				new HashSet<EditorElement>(canvasElementCard));				
	}
	...
	public void determineAreaForCanvas_input() {
		...
		assertEquals(
				new HashSet<Object>(determinedPageArea.getPathInEditor()),
				new HashSet<EditorElement>(canvasElementInput));				
	}
	...
	public void determineAreaForCanvas_page() {
		...
		assertEquals(
				new HashSet<Object>(determinedPageArea.getPathInEditor()),
				new HashSet<EditorElement>(canvasElementPage));				
	}
	...
	public void determineAreaForMenu_menu() {
		...
		assertEquals(
				new HashSet<Object>(determinedPageArea.getPathInEditor()),
				new HashSet<EditorElement>(menuElementMenu));				
	}
	...
	public void determineAreaForMenu_menuButton() {
		...
		assertEquals(
				new HashSet<Object>(determinedPageArea.getPathInEditor()),
				new HashSet<EditorElement>(menuElementMenuButton));				
	}
	...
	public void determineAreaForMenu_icon() {
		...
		assertEquals(
				new HashSet<Object>(determinedPageArea.getPathInEditor()),
				new HashSet<EditorElement>(menuElementIcon));				
	}
	...
	public void determineAreaForDialog() {
		...
		assertEquals(
				new HashSet<Object>(determinedPageArea.getPathInEditor()),
				new HashSet<EditorElement>(dialogBoxElementDialog));				
	}
	...
	public void determineAreaForUnknownArea() {
		...
		assertEquals(
				new HashSet<Object>(determinedPageArea.getPathInEditor()),
				new HashSet<EditorElement>(unknownAreaElement));				
	}
	...
	public void parseLogsSingle() {
		...
		assertEquals(
				new HashSet<UserEvent>(expectedEvent),
				new HashSet<UserEvent>(parsedEvent));
	}
	...
	public void clicksPerArea_allAreas() {
		...
		assertEquals(
				new HashSet<Object>(expectedMap.entrySet()),
				new HashSet<Object>(computedMap.entrySet()));
	}
